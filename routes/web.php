...
Route::middleware('auth')->group(function () {
    ...
    Route::controller(PortfolioController::class)->group(function () {
        Route::get('/portfolio/list','portfolio')->name('portfolio');
    ...
    Route::controller(BlogController::class)->group(function () {
        Route::get('/blog/list','Blog')->name('blog');
    ...
    Route::post('/footer/update/{id}', [FooterController::class, 'UpdateFooter'])->name('update.footer');
...
Route::post('/footer', [FooterController::class, 'footer'])->name('footer');
