        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('store.about.images') }}" method="post" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-md-6">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <input class="form-control" type="file" name="multi_image[]" multiple id="image" readonly style="margin-top: 7rem">
                                    </div>
                                </div>
                                <!-- end row -->
                            </div><hr>
