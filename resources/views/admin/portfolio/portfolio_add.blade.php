                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('store.portfolio') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="row mb-3">
                                    <label for="example-text-input" class="col-sm-3 col-form-label">Portfolio Name: <span class="text-danger">*</span></label>
                                    <div class="col-sm-9">
                                ...
                                <!-- end row -->
                                <div class="row mb-3">
                                    <label for="example-text-input" class="col-sm-3 col-form-label">Portfolio Title: <span class="text-danger">*</span></label>
                                    <div class="col-sm-9">
