                    ...
                    <div class="standard__blog__post">
                        ...
                        <div class="standard__blog__content">
                            ...
                            <ul class="blog__post__meta">
                                ...
                                <li><i class="fal fa-calendar-alt"></i>{{date('d-m-Y', strtotime(trim(str_replace('/','-',$item->updated_at))))}}</li>                                
                                @else
                                    <li><i class="fal fa-calendar-alt"></i>{{date('d-m-Y', strtotime(trim(str_replace('/','-',$item->created_at))))}}</li>                                
                                @endif
