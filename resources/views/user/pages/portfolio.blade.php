                ...
                <div class="row justify-content-center">
                    <div class="col-xl-6 col-lg-8 col-md-10">
                        <div class="breadcrumb__wrap__content">
                            <h2 class="title">{{ $portfolio->portfolio_name }} Details</h2>
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="services__details__content">
                            ...
                            <div class="services__details__img">
                                <div class="row">
                                    @php
                                    $portfolio_more = App\Models\Portfolio::inRandomOrder()->limit(2)->get();
                                    @endphp
                                    <div class="col-sm-6">
                                        {{-- <img src="{{ asset($portfolio_more->portfolio_image) }}" alt="{{ $portfolio_more->portfolio_name }}"> --}}
                                        <img src="{{ asset($portfolio_more[0]->portfolio_image) }}" alt="{{ $portfolio_more[0]->portfolio_name }}">
                                    </div>
                                    <div class="col-sm-6">
                                        <img src="{{ asset($portfolio_more[1]->portfolio_image) }}" alt="{{ $portfolio_more[0]->portfolio_name }}">
                                    </div>
                                </div>
                            </div>
                        </div>
